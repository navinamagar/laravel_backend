                        ...
                        <form method='POST' enctype="multipart/form-data" action="{{route('Posteditcategory',$category->id)}}">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="title" value="{{$category->title}}" class="form-control border border-2 p-2 required >
                                    @error('title')
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea type="text" name="detail"class="form-control border border-2 p-2"required>{{$category->detail}}</textarea> 
                                    @error('detail')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                </div>
